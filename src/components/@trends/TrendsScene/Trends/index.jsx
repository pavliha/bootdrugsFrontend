...
const Trends = ({ classes }) =>
  <Card className={classes.root}>
    <Avatar
      className={classes.media}
      src="http://www.univ.kiev.ua/img/kobzar.jpg"
    />
    <div>
      <Typography variant="title" className={classes.title}>Тарас Шевченко</Typography>
      <CardContent>
        {shortDescriptions('Тарас Шевченко - выдающийся украинский поэт, прозаик, драматург, художник, политический и общественный деятель. Он был человеком универсальных талантов и интересов. Вся его жизнь и творчество были посвящены украинскому народу. Поэт мечтал о тех временах, когда его страна будет независимым суверенным государством, и когда в Украине будет уважаться язык, культура и история народа, тогда и люди будут счастливы.\n' +
